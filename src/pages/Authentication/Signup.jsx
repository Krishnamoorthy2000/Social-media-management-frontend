...
//   const [crtname, setcratname] = useState(false);
  ...
  const HandleSubmit = (set) => {
    if (data.name === "") {
      ...
      setStateO("Loading...");
      axios
        .post(process.env.REACT_APP_USER_SIGNUP_URL, {
          name: data.name,
          email: data.email,
        ...
        .then(
          (response) => {
            ...
            console.log(
              `New user Created on ${response.data.user.createdAt}..user id:${response.data.user._id}`
            );
            setStateO("Sign Up");
            toast({
          ...
          (error) => {
            if (error.response.data) {
              ...
              if (
                error.response.data ===
                'we can"t able to create email alreay in use'
              ) {
                setExistemail(true);
  ...
  return (
    <div className="Container">
      <div className="div1">
        ...
        <div id="formdiv">
          <div id="headingdiv">
            <h1 id="headingline">Let's get your account set up</h1>
          </div>
          ...
          <div className="FullPackage">
            <div>
              ...
              <div className="unilimited">
                <p>
                  Unlimited use of our publishing,analytics, and engagement
                  tools
                </p>
              </div>
            </div>
          ...
          <div className="FullPackage">
            ...
            <div>
              <button
                onClick={() => HandleSubmit(setStateO)}
                className="freetrailbtn2"
              >
                {stateO}
              </button>
            </div>
          ...
          {Existemail && (
            <p id="exitemail" onClick={() => navigate("/signin")}>
              {" "}
              &#x26A0; There seems to be an existing Buffer account for this
              email. Please login.
            </p>
          )}
      ...
      <div className="div2">
        <img
          id="div2imhg"
          src="https://www.linkpicture.com/q/blueLockSignimg.png"
          alt=""
        />
      </div>
    </div>
